...
if (have_posts()) :
	...
	<article <?php post_class('post-entry post-entry-type-'.$post_format . " " . $post_class . " "); avia_markup_helper(array('context' => 'entry')); ?>>
        <div class="entry-content-wrapper clearfix <?php echo $post_format; ?>-content">
            ...
            <div class="search-res-upper" style="border: none;">
  <header class="entry-content-header">
       ...
       <div class="search-thumb"><style>
           
           .search-thumb img{width: 30%;

           }
           
           </style> <?php        the_post_thumbnail(); ?></div> 
                      ...
                      <div class="search-res-lower">
     <div class="search-content">
                            <style>
                          
                                .search-content p{text-align: justify;}
